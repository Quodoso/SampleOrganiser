...
${OBJECTDIR}/AudioFeature.o: AudioFeature.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -I/usr/local/include/essentia -I/usr/local/include/essentia/scheduler -I/usr/local/include/essentia/streaming -I/usr/local/include/essentia/utils `pkg-config --cflags essentia` `pkg-config --cflags fftw3` `pkg-config --cflags fftw3f` `pkg-config --cflags yaml-0.1` `pkg-config --cflags libavformat` `pkg-config --cflags libavformat` `pkg-config --cflags libavutil` `pkg-config --cflags libchromaprint` `pkg-config --cflags gsl` `pkg-config --cflags libgvc` -std=c++17  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AudioFeature.o AudioFeature.cpp
...
${TESTDIR}/tests/featureTest.o: tests/featureTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -I/usr/local/include/essentia -I/usr/local/include/essentia/scheduler -I/usr/local/include/essentia/streaming -I/usr/local/include/essentia/utils -I. `pkg-config --cflags essentia` `pkg-config --cflags fftw3` `pkg-config --cflags fftw3f` `pkg-config --cflags yaml-0.1` `pkg-config --cflags libavformat` `pkg-config --cflags libavformat` `pkg-config --cflags libavutil` `pkg-config --cflags libchromaprint` `pkg-config --cflags gsl` `pkg-config --cflags libgvc` -std=c++17  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/featureTest.o tests/featureTest.cpp
...
${OBJECTDIR}/AudioFeature_nomain.o: ${OBJECTDIR}/AudioFeature.o AudioFeature.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -s -I/usr/local/include/essentia -I/usr/local/include/essentia/scheduler -I/usr/local/include/essentia/streaming -I/usr/local/include/essentia/utils `pkg-config --cflags essentia` `pkg-config --cflags fftw3` `pkg-config --cflags fftw3f` `pkg-config --cflags yaml-0.1` `pkg-config --cflags libavformat` `pkg-config --cflags libavformat` `pkg-config --cflags libavutil` `pkg-config --cflags libchromaprint` `pkg-config --cflags gsl` `pkg-config --cflags libgvc` -std=c++17  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AudioFeature_nomain.o AudioFeature.cpp;\
	else  \
